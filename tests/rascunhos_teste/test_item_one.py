...
class TestItemOne(BaseCase):
    ...
    def test_item_one_has_get_method(self):
        pass

    def test_item_one_has_put_method(self):
        pass

    def test_item_one_has_patch_method(self):
        pass

    def test_item_one_has_delete_method(self):
        pass
    
    def test_item_one_id_is_objectid(self):
        pass
